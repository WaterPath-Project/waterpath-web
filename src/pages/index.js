...
const IndexPage = () => {
  ...
  <nav className="fixed w-full z-20 top-0 pt-10 start-0 bg-back-white ">
    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div className="flex space-x-3 md:space-x-4">
          <a href="#" className="text-blue ms-16 text-xl"><FiGitlab/></a>
          <a href="#" className="text-blue ms-16 text-xl"><FiGithub/></a>
  ...
  <div className={"mt-36 w-full bg-hero2 bg-no-repeat container mx-auto"}>
      <div className="relative text-center pt-20 pb-20">
        ...
        <button type="button" class="absolute left-1/2 transform -translate-x-1/2 bottom-0 text-blue font-body font-extrabold bg-green focus:ring-4 focus:ring-blue-500 font-medium rounded-md text-sm px-5 py-2.5">More about WaterPath</button>
      </div>
      ...
      <div class="footer mt-100 bg-sand absolute bottom-0 left-0 w-full">
        <div className={"pt-24 w-full container mx-auto"}>
            ...
            <div className="md:grid-cols-4 grid gap-24">
              ...
              <div className="flex-column mx-auto self-center"><img style={{height: "28px", width: "auto"}} src={venthic}/></div>
            </div>
