      ...
      <div className={'grid md:grid-cols-3 xs:grid-cols-1 gap-0.5'}>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="pl-8 list-disc">
                <li><b>Wageningen University</b>, represented by P.I. Dr. <span className="text-green-500 font-bold">Nynke Hofstra</span>, postdoc Dr. <span className="text-green-500 font-bold">Stijn Peeters</span> and model developer and programmer <span className="text-green-500 font-bold">Lisanne Nauta</span> from the Water Systems and Global Change group. The team brings the GloWPa model to the project and leads the overall project activities and GloWPa extensions. </li>
